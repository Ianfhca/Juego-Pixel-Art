...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_pruebas" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4d94df03#;
   pragma Export (C, u00001, "pruebasB");
   ...
   u00005 : constant Version_32 := 16#5a7166a4#;
   ...
   u00105 : constant Version_32 := 16#e5331d7b#;
   pragma Export (C, u00105, "ada__calendar__formattingB");
   u00106 : constant Version_32 := 16#0dbf7387#;
   pragma Export (C, u00106, "ada__calendar__formattingS");
   u00107 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00107, "ada__calendar__time_zonesB");
   u00108 : constant Version_32 := 16#07d0e97b#;
   pragma Export (C, u00108, "ada__calendar__time_zonesS");
   u00109 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00109, "system__val_intB");
   u00110 : constant Version_32 := 16#875fe85b#;
   pragma Export (C, u00110, "system__val_intS");
   u00111 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00111, "system__val_unsB");
   u00112 : constant Version_32 := 16#33208002#;
   pragma Export (C, u00112, "system__val_unsS");
   u00113 : constant Version_32 := 16#c5134340#;
   pragma Export (C, u00113, "system__val_realB");
   u00114 : constant Version_32 := 16#3cdf6ded#;
   pragma Export (C, u00114, "system__val_realS");
   u00115 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00115, "system__exn_llfB");
   u00116 : constant Version_32 := 16#8ede3ae4#;
   pragma Export (C, u00116, "system__exn_llfS");
   u00117 : constant Version_32 := 16#36373acb#;
   ...
   u00120 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00120, "system__powten_tableS");
   u00121 : constant Version_32 := 16#4fedafb0#;
   pragma Export (C, u00121, "ada__directories__validityB");
   u00122 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00122, "ada__directories__validityS");
   u00123 : constant Version_32 := 16#bf363ed2#;
   pragma Export (C, u00123, "ada__strings__fixedB");
   u00124 : constant Version_32 := 16#fec1aafc#;
   pragma Export (C, u00124, "ada__strings__fixedS");
   u00125 : constant Version_32 := 16#144f64ae#;
   ...
   u00127 : constant Version_32 := 16#351539c5#;
   pragma Export (C, u00127, "ada__strings__unboundedB");
   u00128 : constant Version_32 := 16#6552cb60#;
   ...
   u00135 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00135, "system__compare_array_unsigned_8B");
   u00136 : constant Version_32 := 16#9ba3f0b5#;
   ...
   u00144 : constant Version_32 := 16#c779f0d3#;
   ...
   u00156 : constant Version_32 := 16#039168f8#;
   ...
   u00158 : constant Version_32 := 16#230d1ce1#;
   pragma Export (C, u00158, "system__file_attributesS");
   u00159 : constant Version_32 := 16#c86f510c#;
   pragma Export (C, u00159, "system__os_constantsS");
   u00160 : constant Version_32 := 16#ec083f01#;
   pragma Export (C, u00160, "system__file_ioB");
   u00161 : constant Version_32 := 16#95d1605d#;
   ...
   u00164 : constant Version_32 := 16#cf3f1b90#;
   pragma Export (C, u00164, "system__file_control_blockS");
   u00165 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00165, "system__regexpB");
   u00166 : constant Version_32 := 16#119226f4#;
   pragma Export (C, u00166, "system__regexpS");
   u00167 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00167, "ada__integer_text_ioB");
   u00168 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00168, "ada__integer_text_ioS");
   u00169 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00169, "ada__text_ioB");
   u00170 : constant Version_32 := 16#03e83e15#;
   pragma Export (C, u00170, "ada__text_ioS");
   u00171 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00171, "ada__text_io__integer_auxB");
   u00172 : constant Version_32 := 16#2fe01d89#;
   pragma Export (C, u00172, "ada__text_io__integer_auxS");
   u00173 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00173, "ada__text_io__generic_auxB");
   u00174 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00174, "ada__text_io__generic_auxS");
   u00175 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00175, "system__img_biuB");
   u00176 : constant Version_32 := 16#c00475f6#;
   pragma Export (C, u00176, "system__img_biuS");
   u00177 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00177, "system__img_llbB");
   u00178 : constant Version_32 := 16#81c36508#;
   pragma Export (C, u00178, "system__img_llbS");
   u00179 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00179, "system__img_lliB");
   u00180 : constant Version_32 := 16#23efd4e9#;
   pragma Export (C, u00180, "system__img_lliS");
   u00181 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00181, "system__img_llwB");
   u00182 : constant Version_32 := 16#28af469e#;
   pragma Export (C, u00182, "system__img_llwS");
   u00183 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00183, "system__img_wiuB");
   u00184 : constant Version_32 := 16#ae45f264#;
   pragma Export (C, u00184, "system__img_wiuS");
   u00185 : constant Version_32 := 16#fd897d69#;
   pragma Export (C, u00185, "laboratorio10B");
   u00186 : constant Version_32 := 16#eb5bee1b#;
   pragma Export (C, u00186, "laboratorio10S");
   u00187 : constant Version_32 := 16#cd2b5875#;
   pragma Export (C, u00187, "funciones_auxB");
   u00188 : constant Version_32 := 16#e89652f4#;
   pragma Export (C, u00188, "funciones_auxS");
   u00189 : constant Version_32 := 16#cefe8585#;
   pragma Export (C, u00189, "nt_consoleB");
   u00190 : constant Version_32 := 16#548ec638#;
   pragma Export (C, u00190, "nt_consoleS");
   u00191 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00191, "system__concat_2B");
   u00192 : constant Version_32 := 16#300056e8#;
   pragma Export (C, u00192, "system__concat_2S");
   u00193 : constant Version_32 := 16#273384e4#;
   pragma Export (C, u00193, "system__img_enum_newB");
   u00194 : constant Version_32 := 16#53ec87f8#;
   pragma Export (C, u00194, "system__img_enum_newS");
   ...
   u00197 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00197, "system__concat_5B");
   u00198 : constant Version_32 := 16#b5fec216#;
